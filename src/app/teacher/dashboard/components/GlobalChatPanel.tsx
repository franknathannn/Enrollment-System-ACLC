  ...
  return (
    <div className={cn("flex gap-2 group animate-in slide-in-from-bottom-2 duration-400 relative",
      ...
      <div className={cn("flex flex-col max-w-[78%] min-w-0", isMe ? "items-end" : "items-start")}>
        <span className={cn("text-[9px] font-bold mb-1 px-1 flex items-center gap-1",
        ...
        <div className={cn("flex items-center gap-1.5 relative w-full min-w-0", isMe ? "flex-row-reverse" : "flex-row")}>
          {isEditing ? (
            ...
            <div className={cn("flex flex-col flex-1 min-w-0", isMe ? "items-end" : "items-start")}>
              {msg.content && (
                <div className={cn("p-3 rounded-[20px] text-[13px] font-medium leading-relaxed shadow-sm border whitespace-pre-wrap break-all",
