      ...
      <div className={`rounded-[40px] border p-8 md:p-10 flex flex-col lg:flex-row gap-10 overflow-hidden relative group ${card}`}>
        ...
        <div className="flex-1 space-y-6">
            <div className="flex items-center gap-4">
               ...
               <div>
                  <p className={`text-[10px] font-black uppercase tracking-[0.4em] ${sub}`}>Security Center</p>
                  <h2 className={`text-3xl font-black italic tracking-tighter uppercase ${head}`}>Attendance Regulator</h2>
               </div>
            </div>
                            ...
                            <div className="flex items-center gap-2">
                               {susp.timeline.map((t, tidx) => (
                                 <div key={t.subject} className="flex flex-col items-center gap-1.5 group/point relative">
                                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-[11px] font-black transition-all border outline outline-offset-2 outline-transparent ${
                                      t.status === "P" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-500" :
