...
import { useSchedule }           from "../../../sections/hooks/useSchedule"
...
export const ScheduleTab = memo(function ScheduleTab({
  ...
  const {
    ...
    addSchedules, clearSchedules, massUpdateEntries
