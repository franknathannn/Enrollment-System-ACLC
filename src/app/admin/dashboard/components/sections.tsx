...
export const OverviewGrid = memo(function OverviewGrid({ stats, isDarkMode }: { stats: any, isDarkMode: boolean }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
      <StatCard title="Students Enrolled" value={<AnimatedNumber value={stats.totalAccepted} />} icon={<CheckCircle2 />} color="text-emerald-600 dark:text-emerald-400" bg="bg-emerald-50" trend="View Enrolled" isDarkMode={isDarkMode} tooltip="Total number of students officially enrolled" href="/admin/enrolled" />
      <StatCard title="ICT Enrolled" value={<AnimatedNumber value={stats.ictAccepted} />} icon={<Cpu />} color="text-indigo-600 dark:text-indigo-400" bg="bg-indigo-50" trend="View Applicants" isDarkMode={isDarkMode} tooltip="Students enrolled in Information and Communications Technology" href="/admin/applicants" />
      <StatCard title="GAS Enrolled" value={<AnimatedNumber value={stats.gasAccepted} />} icon={<BookText />} color="text-orange-600 dark:text-orange-400" bg="bg-orange-50" trend="View Applicants" isDarkMode={isDarkMode} tooltip="Students enrolled in General Academic Strand" href="/admin/applicants" />
      <StatCard title="Pending Applicants" value={<AnimatedNumber value={stats.pending} />} icon={<Clock />} color="text-amber-600 dark:text-amber-400" bg="bg-amber-50" trend="View Applicants" isDarkMode={isDarkMode} tooltip="Applications awaiting review or approval" href="/admin/applicants" />
    ...
    >
      <div className="flex flex-col sm:flex-row justify-between items-start mb-8 gap-4">
        ...
        <Tooltip>
          <TooltipTrigger>
            <Badge
              className={`px-4 py-2 rounded-xl font-black text-[9px] uppercase border-none ${spikeAnalysis.alertLevel === 'critical'
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <span className={`text-xl font-black ${spikeAnalysis.alertLevel === 'critical'
        ...
        >
          <div
            className={`h-full rounded-2xl transition-all duration-1000 ease-out ${spikeAnalysis.alertLevel === 'critical'
              ? 'bg-red-500'
              : spikeAnalysis.alertLevel === 'warning'
