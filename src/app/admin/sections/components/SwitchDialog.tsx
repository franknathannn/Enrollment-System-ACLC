            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 relative z-10">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black text-xs shadow-sm ${isCurrent || isFull
                  ...
                  <div className="flex flex-col items-start text-left">
                    <span className={`font-black uppercase text-xs tracking-tight ${isCurrent || isFull ? 'text-slate-400' : isDarkMode ? 'text-white' : 'text-slate-900'
                      }`}>
                      {sec.section_name}
                    </span>
