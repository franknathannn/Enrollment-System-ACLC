// c:\Users\Nath\Documents\Enrollment System\enrollment-system\src\app\admin\sections\components\StudentDossier.tsx

import { memo, useState, useRef, useEffect, useMemo } from "react"
import { toast } from "sonner"
import { supabase } from "@/lib/supabase/admin-client"

// Import components from applicants feature to ensure consistency
...
export const StudentDossier = memo(function StudentDossier({
  ...
  const handleDocChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const fileName = `${student.lrn}__${Date.now()}.`
