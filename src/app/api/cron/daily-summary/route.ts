      ...
      const htmlContent = `
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #1f2937; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9fafb;">
          ...
          <div style="background-color: #ffffff; border-radius: 16px; padding: 40px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); border: 1px solid #e5e7eb;">
            ...
            <p style="font-size: 16px; line-height: 1.6; color: #4b5563;">We would like to inform you that your ${pronoun}, <strong>${student.first_name} ${student.last_name}</strong>, has completed their school day at <strong>ACLC NORTHBAY</strong>. Below is their full attendance summary for today.</p>
            ...
            <p style="margin-top: 20px; font-size: 12px; color: #64748b;">This is an automated system message generated by ACLC NORTHBAY.</p>
          </div>
